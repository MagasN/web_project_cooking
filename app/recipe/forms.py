...
class AddRecipeForm(FlaskForm):
    title = StringField(
        ...
        render_kw={"class": "form-control", "id": "floatingInput", "placeholder": "Название"},
    )
    image_recipe = FileField(
        "Фото блюда",
        validators=[
            FileAllowed(
                ["png", "jpg", "jpeg", "gif"],
        ...
        render_kw={"class": "input-group-text", "id": "inputGroupFile01"},
    )
    decription_recipe = StringField(
        "Краткое описание",
        validators=[Length(max=200)],
        render_kw={"class": "form-control", "id": "floatingInput", "placeholder": "Краткое описание"},
    )
